 ...
 * 
 */
package net.eshop.plugin.paypal;
...
import net.eshop.plugin.PaymentPlugin.FeeType;
import net.eshop.plugin.paypal.PaypalPlugin.Currency;
import net.eshop.service.PluginConfigService;
...
public class PaypalController extends BaseController
{
	...
	public String setting(ModelMap model)
	{
		...
		return "/net/eshop/plugin/paypal/setting";
	}
