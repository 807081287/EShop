...
public class OrderDaoImpl extends BaseDaoImpl<Order, Long> implements OrderDao
{
	...
	public Order findBySn(String sn)
	{
		...
		try
		{
			return entityManager.createQuery(jpql, Order.class).setFlushMode(FlushModeType.COMMIT).setParameter("sn", sn)
					.getSingleResult();
		}
	...
	public Long waitingPaymentCount(Member member)
	{
		...
		criteriaQuery.select(root);
		Predicate restrictions = criteriaBuilder.conjunction();
		restrictions = criteriaBuilder.and(restrictions, criteriaBuilder.notEqual(root.get("orderStatus"), OrderStatus.completed),
