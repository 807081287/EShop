...
import net.eshop.dao.ConsultationDao;
import net.eshop.entity.Consultation;
...
public class ConsultationDaoImpl extends BaseDaoImpl<Consultation, Long> implements ConsultationDao
{
	...
	public List<Consultation> findList(Member member, Product product, Boolean isShow, Integer count, List<Filter> filters,
			List<Order> orders)
	{
