...
public class MessageController extends BaseController
{
			...
			@RequestParam(defaultValue = "false") Boolean isDraft, HttpServletRequest request, RedirectAttributes redirectAttributes)
	{
		...
		if (isDraft)
		{
			addFlashMessage(redirectAttributes, net.eshop.Message.success("shop.member.message.saveDraftSuccess"));
			return "redirect:draft.jhtml";
		}
		else
		{
			addFlashMessage(redirectAttributes, net.eshop.Message.success("shop.member.message.sendSuccess"));
	...
	public String reply(Long id, String content, HttpServletRequest request, RedirectAttributes redirectAttributes)
	{
		...
		{
			addFlashMessage(redirectAttributes, net.eshop.Message.success("shop.member.message.replySuccess"));
			return "redirect:list.jhtml";
		}
	}
	...
	public @ResponseBody net.eshop.Message delete(Long id)
	{
		Member member = memberService.getCurrent();
