...
import net.eshop.Setting.ConsultationAuthority;
import net.eshop.Setting.ReviewAuthority;
import net.eshop.Setting.RoundType;
import net.eshop.Setting.StockAllocationTime;
import net.eshop.Setting.WatermarkPosition;
import net.eshop.service.CacheService;
import net.eshop.service.FileService;
import net.eshop.service.MailService;
