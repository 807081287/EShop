...
import net.eshop.service.CouponService;
...
public class CouponController extends BaseController
{
	...
	public ModelAndView download(Long id, Integer count, ModelMap model)
	{
		...
		return new ModelAndView(new ExcelView(filename, null, new String[]
		{ "code" }, new String[]
		{ message("admin.coupon.title") }, null, null, data, contents), model);
	}
