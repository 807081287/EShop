...
import net.eshop.entity.Member.Gender;
import net.eshop.entity.MemberAttribute.Type;
import net.eshop.service.AdminService;
import net.eshop.service.AreaService;
import net.eshop.service.MemberAttributeService;
...
public class MemberController extends BaseController
{
	...
	public String update(Member member, Long memberRankId, Integer modifyPoint, BigDecimal modifyBalance, String depositMemo,
			HttpServletRequest request, RedirectAttributes redirectAttributes)
	{
		...
		if (member.getPassword() != null
				&& (member.getPassword().length() < setting.getPasswordMinLength() || member.getPassword().length() > setting
		...
		BeanUtils.copyProperties(member, pMember, new String[]
		{ "username", "point", "amount", "balance", "registerIp", "loginIp", "loginDate", "safeKey", "cart", "orders", "deposits",
				"payments", "couponCodes", "receivers", "reviews", "consultations", "favoriteProducts", "productNotifies",
