...
public class CaptchaEngine extends ListImageCaptchaEngine
{
	...
	/** 随机背景图片路径 */
	private static final String BACKGROUND_IMAGE_PATH = "/net/eshop/captcha/";

	/**
	 * 随机字体
	 */
	private static final Font[] FONTS = new Font[]
	{ new Font("nyala", Font.BOLD, MAX_FONT_SIZE), new Font("Arial", Font.BOLD, MAX_FONT_SIZE),
	...
	{ new Color(255, 255, 255), new Color(255, 220, 220), new Color(220, 255, 255), new Color(220, 220, 255),
