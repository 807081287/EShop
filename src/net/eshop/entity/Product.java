...
public class Product extends BaseEntity
{
	...
	/** 是否是基础商品（这种商品不能作为直接购买的商品，其库存必须设置为0， 而且这个商品下面有很多子商品，即：各种规格的商品） */
	private Boolean isBaseProduct;

	/** 变体 即： 子产品 **/
	private Set<Product> variants;

	/** 父商品 即 基础商品 (只考虑两层树形机构) **/
	...
	static
	{
		try
		{
			...
			final org.dom4j.Document document = new SAXReader().read(eshopXmlFile);
			final org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/eshop/template[@id='productContent']");
	 ...
	 *           已分配库存
	 */
	public void setAllocatedStock(final Integer allocatedStock)
	{
	 ...
	 *           库存备注
	 */
	public void setStockMemo(final String stockMemo)
	{
	 ...
	 *           是否上架
	 */
	public void setIsMarketable(final Boolean isMarketable)
	{
	...
	/**
	 * @param isBaseProduct
	 *           the isBaseProduct to set
	 */
	public void setIsBaseProduct(final Boolean isBaseProduct)
	{
	 ...
	 *           the variants to set
	 */
	public void setVariants(final Set<Product> variants)
	{
	 ...
	 *           评分数
	 */
	public void setScoreCount(final Long scoreCount)
	{
	 ...
	 *           周点击数
	 */
	public void setWeekHits(final Long weekHits)
	{
	 ...
	 *           月点击数
	 */
	public void setMonthHits(final Long monthHits)
	{
	 ...
	 *           周销量
	 */
	public void setWeekSales(final Long weekSales)
	{
	 ...
	 *           月销量
	 */
	public void setMonthSales(final Long monthSales)
	{
	 ...
	 *           周点击数更新日期
	 */
	public void setWeekHitsDate(final Date weekHitsDate)
	{
	 ...
	 *           月点击数更新日期
	 */
	public void setMonthHitsDate(final Date monthHitsDate)
	{
	 ...
	 *           周销量更新日期
	 */
	public void setWeekSalesDate(final Date weekSalesDate)
	{
	 ...
	 *           月销量更新日期
	 */
	public void setMonthSalesDate(final Date monthSalesDate)
	{
	 ...
	 *           商品属性值10
	 */
	public void setAttributeValue10(final String attributeValue10)
	{
	 ...
	 *           商品属性值11
	 */
	public void setAttributeValue11(final String attributeValue11)
	{
	 ...
	 *           商品属性值12
	 */
	public void setAttributeValue12(final String attributeValue12)
	{
	 ...
	 *           商品属性值13
	 */
	public void setAttributeValue13(final String attributeValue13)
	{
	 ...
	 *           商品属性值14
	 */
	public void setAttributeValue14(final String attributeValue14)
	{
	 ...
	 *           商品属性值15
	 */
	public void setAttributeValue15(final String attributeValue15)
	{
	 ...
	 *           商品属性值16
	 */
	public void setAttributeValue16(final String attributeValue16)
	{
	 ...
	 *           商品属性值17
	 */
	public void setAttributeValue17(final String attributeValue17)
	{
	 ...
	 *           商品属性值18
	 */
	public void setAttributeValue18(final String attributeValue18)
	{
	 ...
	 *           商品属性值19
	 */
	public void setAttributeValue19(final String attributeValue19)
	{
	 ...
	 *           收藏会员
	 */
	public void setFavoriteMembers(final Set<Member> favoriteMembers)
	{
	 ...
	 *           规格
	 */
	public void setSpecifications(final Set<Specification> specifications)
	{
	 ...
	 *           规格值
	 */
	public void setSpecificationValues(final Set<SpecificationValue> specificationValues)
	{
	 ...
	 *           赠品项
	 */
	public void setGiftItems(final Set<GiftItem> giftItems)
	{
	 ...
	 *           会员价
	 */
	public void setMemberPrice(final Map<MemberRank, BigDecimal> memberPrice)
	{
	 ...
	 *           参数值
	 */
	public void setParameterValue(final Map<Parameter, String> parameterValue)
	{
	...
	public String getAttributeValue(final Attribute attribute)
	{
		if (attribute != null && attribute.getPropertyIndex() != null)
		{
			try
			{
				final String propertyName = ATTRIBUTE_VALUE_PROPERTY_NAME_PREFIX + attribute.getPropertyIndex();
	 ...
	 */
	@Transient
	public void setAttributeValue(final Attribute attribute, String value)
	{
		if (attribute != null && attribute.getPropertyIndex() != null)
		{
	...
	{
		final List<Product> siblings = new ArrayList<Product>();
		if (getGoods() != null && getGoods().getProducts() != null)
		{
			for (final Product product : getGoods().getProducts())
			{
	...
	{
		final Set<Promotion> allPromotions = new HashSet<Promotion>();
		...
		final Set<Promotion> validPromotions = new TreeSet<Promotion>();
		for (final Promotion promotion : allPromotions)
		{
	 ...
	 */
	@Transient
	public boolean isValid(final Promotion promotion)
	{
		if (promotion == null || !promotion.hasBegun() || promotion.hasEnded() || promotion.getMemberRanks() == null
				|| promotion.getMemberRanks().isEmpty())
		{
	...
	{
		final Set<Member> favoriteMembers = getFavoriteMembers();
		if (favoriteMembers != null)
		{
			for (final Member favoriteMember : favoriteMembers)
			{
				favoriteMember.getFavoriteProducts().remove(this);
			}
		}
		final Set<Promotion> promotions = getPromotions();
		if (promotions != null)
		{
